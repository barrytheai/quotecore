          ...
          <div className="flex flex-col justify-between p-8 flex-1">
            <div>
              ...
              <p className="mt-5 text-zinc-600 leading-relaxed text-sm">
                Give Shaun 15 minutes and he&apos;ll show you how QuoteCore+ will save you hours every week on quoting, material orders, and job admin.
              </p>
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-center text-xs text-zinc-400">
                Free coffee voucher sent after completed call.<br />One per UK roofing business.{" "}
