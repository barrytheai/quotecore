...
const SUPABASE_SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhYXZ2ZnR0a2VzZHpibHR0bWJ5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTA0Nzk4OCwiZXhwIjoyMDkwNjIzOTg4fQ.Fn2IdHAt6D4nRqLrpKGKVAt-Q2EWkau0w6ZyYRi_d1g";
const RESEND_API_KEY = process.env.RESEND_API_KEY || "re_agJdUCCM_vWmhw6qL9oGfqiqbkvS7AETD";
