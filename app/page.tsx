              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-zinc-200 bg-black shadow-[0_30px_120px_rgba(0,0,0,0.15)]">
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-3 bg-gradient-to-t from-black/70 via-black/35 to-transparent px-5 pb-5 pt-12">
                  ...
                  >
                    {isMuted ? (
                      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                        <path d="M13.5 5.23v13.54a1 1 0 01-1.64.77L7.41 16H3.5a1 1 0 01-1-1v-6a1 1 0 011-1h3.91l4.45-3.54A1 1 0 0113.5 5.23zM20.28 8.8a1 1 0 010 1.41L18.5 12l1.78 1.79a1 1 0 11-1.41 1.41L17.09 13.4l-1.8 1.8a1 1 0 01-1.41-1.41L15.67 12l-1.79-1.79a1 1 0 011.41-1.41l1.8 1.8 1.78-1.8a1 1 0 011.41 0z" />
                      </svg>
                    ) : (
                      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
