      ...
      <main className="min-h-screen bg-white text-zinc-950">
        ...
        <section className="bg-[#FF6B35] py-20">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-white/70">What roofers say</p>
            <h2 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">Trusted by roofing contractors</h2>
          </div>
          ...
          <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-3">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="rounded-[1.75rem] bg-white/15 p-7 backdrop-blur-sm border border-white/20"
              >
                {/* Stars */}
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
                ...
                {/* Quote */}
                <p className="mt-4 text-sm leading-relaxed text-white/90">&ldquo;{t.quote}&rdquo;</p>

                {/* Author */}
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-xs font-semibold text-[#FF6B35]">
                    {t.initials}
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-white">{t.name}</p>
                    <p className="text-xs text-white/70">{t.business}</p>
                  </div>
                </div>
              </div>
            ))}
