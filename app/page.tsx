      ...
      <main className="min-h-screen bg-white text-zinc-950">
        ...
        <footer className="border-t border-zinc-200 py-10 text-center text-sm text-zinc-500">
          ...
          <div className="mt-4 flex items-center justify-center gap-5">
            <a href="https://www.instagram.com/quotecore_plus" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-zinc-400 hover:text-zinc-700 transition-colors">
            ...
            <a href="https://www.facebook.com/share/1CwAeUpnCq/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-zinc-400 hover:text-zinc-700 transition-colors">
            ...
            <a href="https://x.com/quotecoreplus" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-zinc-400 hover:text-zinc-700 transition-colors">
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://www.tiktok.com/@quotecoreplus" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-zinc-400 hover:text-zinc-700 transition-colors">
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.24 8.24 0 004.84 1.55V6.79a4.85 4.85 0 01-1.07-.1z"/></svg>
            </a>
            <a href="https://www.youtube.com/@quotecoreplus" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-zinc-400 hover:text-zinc-700 transition-colors">
            ...
            <a href="https://www.linkedin.com/company/quotecore/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-zinc-400 hover:text-zinc-700 transition-colors">
